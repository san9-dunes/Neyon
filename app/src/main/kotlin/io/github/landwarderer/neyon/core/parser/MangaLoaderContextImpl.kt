...
import io.github.landwarderer.neyon.core.network.webview.WebViewRequestInterceptorExecutor
...
class MangaLoaderContextImpl @Inject constructor(
    ...
    override suspend fun interceptWebViewRequests(
        ...
        val config = io.github.landwarderer.neyon.core.network.webview.InterceptionConfig(
            timeoutMs = timeout,
            maxRequests = 100,
    ...
    override suspend fun interceptWebViewRequests(
        ...
        val appConfig = io.github.landwarderer.neyon.core.network.webview.InterceptionConfig(
