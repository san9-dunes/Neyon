...
import io.github.landwarderer.neyon.mihon.parsers.network.OkHttpWebClient
import io.github.landwarderer.neyon.mihon.parsers.network.WebClient
import io.github.landwarderer.neyon.mihon.parsers.util.FaviconParser
import io.github.landwarderer.neyon.mihon.parsers.util.LinkResolver
import io.github.landwarderer.neyon.mihon.parsers.util.RelatedContentFinder
import io.github.landwarderer.neyon.mihon.parsers.util.convertToContentListFilter
import io.github.landwarderer.neyon.mihon.parsers.util.toAbsoluteUrl
import io.github.landwarderer.neyon.mihon.parsers.util.toContentSearchQueryCapabilities
...
public abstract class AbstractContentParser @InternalParsersApi constructor(
	...
	protected open val userAgentKey: ConfigKey.UserAgent = try {
		...
		ConfigKey.UserAgent(io.github.landwarderer.neyon.mihon.parsers.network.UserAgents.CHROME_MOBILE)
	}
