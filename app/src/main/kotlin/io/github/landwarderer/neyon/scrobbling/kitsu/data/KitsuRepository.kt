package io.github.landwarderer.neyon.scrobbling.kitsu.data
...
import io.github.landwarderer.neyon.core.util.ext.parseJsonOrNull
...
import io.github.landwarderer.neyon.scrobbling.kitsu.data.KitsuInterceptor.Companion.VND_JSON
...
class KitsuRepository(
	...
	override val oauthUrl: String = "neyon+kitsu://auth"
