...
import io.github.landwarderer.neyon.core.util.ext.getEnumValue
import io.github.landwarderer.neyon.core.util.ext.observeChanges
import io.github.landwarderer.neyon.core.util.ext.putAll
import io.github.landwarderer.neyon.core.util.ext.putEnumValue
import io.github.landwarderer.neyon.core.util.ext.takeIfReadable
...
class AppSettings @Inject constructor(@ApplicationContext context: Context) {
	...
	var suggestionsSortOrder: ListSortOrder
		get() = prefs.getEnumValue(KEY_SUGGESTIONS_ORDER, ListSortOrder.UPDATED)
		set(value) = prefs.edit { putEnumValue(KEY_SUGGESTIONS_ORDER, value) }
	...
	companion object {
		...
		const val KEY_SUGGESTIONS_ORDER = "suggestions_order"
