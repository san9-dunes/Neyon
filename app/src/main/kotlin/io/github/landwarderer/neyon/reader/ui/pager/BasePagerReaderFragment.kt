...
import io.github.landwarderer.neyon.core.ui.list.lifecycle.PagerLifecycleDispatcher
import io.github.landwarderer.neyon.core.util.ext.doOnPageChanged
import io.github.landwarderer.neyon.core.util.ext.findCurrentViewHolder
import io.github.landwarderer.neyon.core.util.ext.observe
import io.github.landwarderer.neyon.core.util.ext.recyclerView
import io.github.landwarderer.neyon.core.util.ext.resetTransformations
import io.github.landwarderer.neyon.databinding.FragmentReaderPagerBinding
import io.github.landwarderer.neyon.reader.domain.PageLoader
import io.github.landwarderer.neyon.reader.ui.ReaderState
import io.github.landwarderer.neyon.reader.ui.pager.standard.NoAnimPageTransformer
import io.github.landwarderer.neyon.reader.ui.pager.standard.PageAnimTransformer
import io.github.landwarderer.neyon.reader.ui.pager.standard.PageHolder
import io.github.landwarderer.neyon.reader.ui.pager.standard.PagerEventSupplier
import io.github.landwarderer.neyon.reader.ui.pager.standard.PagesAdapter
...
abstract class BasePagerReaderFragment : BaseReaderFragment<FragmentReaderPagerBinding>(),
	...
	protected open fun onInitPager(pager: ViewPager2) {
		pager.offscreenPageLimit = viewModel.pagePreloadLimit
	}
