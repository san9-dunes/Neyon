package io.github.landwarderer.neyon.stats.ui.sheet
...
import io.github.landwarderer.neyon.databinding.SheetStatsMangaBinding
import org.koitharu.kotatsu.parsers.util.format
import io.github.landwarderer.neyon.stats.ui.views.BarChartView
...
class MangaStatsSheet : BaseAdaptiveSheet<SheetStatsMangaBinding>(), View.OnClickListener {
	...
	override fun onViewBindingCreated(binding: SheetStatsMangaBinding, savedInstanceState: Bundle?) {
		...
		binding.chartView.barColor = NeyonColors.ofManga(binding.root.context, viewModel.manga)
