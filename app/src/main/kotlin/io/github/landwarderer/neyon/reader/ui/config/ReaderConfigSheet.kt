package io.github.landwarderer.neyon.reader.ui.config
...
import io.github.landwarderer.neyon.core.util.progress.IntPercentLabelFormatter
import io.github.landwarderer.neyon.databinding.SheetReaderConfigBinding
...
import io.github.landwarderer.neyon.reader.ui.ScreenOrientationHelper
...
class ReaderConfigSheet :
    ...
    override fun onViewBindingCreated(
        ...
        binding.buttonHidePage.setOnClickListener(this)
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.button_hide_page -> {
                findParentCallback(Callback::class.java)?.onHidePageClick() ?: return
                dismissAllowingStateLoss()
            }
