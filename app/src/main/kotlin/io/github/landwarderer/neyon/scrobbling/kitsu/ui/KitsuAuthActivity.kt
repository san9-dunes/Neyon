package io.github.landwarderer.neyon.scrobbling.kitsu.ui
...
import io.github.landwarderer.neyon.databinding.ActivityKitsuAuthBinding
...
class KitsuAuthActivity : BaseActivity<ActivityKitsuAuthBinding>(),
	...
	private fun continueAuth() {
		...
		val url = "neyon://kitsu-auth?code=" + "$email;$password".urlEncoded()
